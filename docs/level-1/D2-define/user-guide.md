...
- Период окупаемости CAC < 18 месяцев
- Валовая маржа > 70% для SaaS продуктов
- Месячный отток < 5% для SMB, < 2% для Enterprise
...
**Метрики успеха:**
- Оценка понимания ценностного предложения > 4/5
- Соотношение LTV:CAC > 3:1 в финансовой модели
- Четко определен приоритетный целевой сегмент №1
- Предпочтение позиционирования над конкурентами > 60%
- Рейтинг одобрения руководства > 8/10
